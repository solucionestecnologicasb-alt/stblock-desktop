...
class Prompt extends React.Component {
    ...
    handleVariableTypeChange (e) {
        this.setState({variableType: e.target.value});
    }
    ...
    handleOk () {
        let finalValue = this.state.inputValue;
        if (this.props.showVariableOptions && this.state.variableType) {
            const suffix = ` [${this.state.variableType}]`;
            finalValue = finalValue.replace(/\s*\[(int|float|char|String)\]\s*$/i, '');
            finalValue += suffix;
        }
        this.props.onOk(finalValue, {
    ...
    render () {
        return (
            <PromptComponent
                ...
                onVariableTypeChange={this.handleVariableTypeChange}
