...
import {setConnectionModalPeripheralName, clearConnectionModalPeripheralName} from '../reducers/connection-modal';
...
class ConnectionModal extends React.Component {
    ...
    handleConnecting (peripheralId, peripheralName) {
        ...
        this._pendingPeripheralName = peripheralName || peripheralId;
        this.setState({
    ...
    handleDisconnect () {
        try {
            ...
            this.props.onClearPeripheralName();
        } finally {
            this.props.onCancel();
        }
    }
    ...
    handleConnected () {
        ...
        // Save the peripheral name to redux
        if (this._pendingPeripheralName) {
            this.props.onSetPeripheralName(this._pendingPeripheralName);
            this._pendingPeripheralName = null;
        }
        analytics.event({
            category: 'extensions',
            action: 'connected',
    ...
    render () {
        ...
        const device = deviceData.find(d => d.deviceId === this.props.extensionId);
        const deviceIconURL = device ? device.iconURL : null;
        return (
            <ConnectionModalComponent
                ...
                connectionSmallIconURL={deviceIconURL || (this.state.extension && this.state.extension.connectionSmallIconURL)}
...
ConnectionModal.propTypes = {
    ...
    onClearPeripheralName: PropTypes.func.isRequired,
    onSetPeripheralName: PropTypes.func.isRequired,
