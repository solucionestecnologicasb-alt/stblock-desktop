...
const messages = defineMessages({
    shouldDeleteSpriteMessage: {
        defaultMessage: '¿Estás seguro de que quieres eliminar este personaje?',
    ...
    shouldDeleteCostumeMessage: {
        defaultMessage: '¿Estás seguro de que quieres eliminar este disfraz?',
    ...
    shouldDeleteSoundMessage: {
        defaultMessage: '¿Estás seguro de que quieres eliminar este sonido?',
