    ...
    >
        <Box className={styles.body}>
            ...
            {props.showVariableOptions ?
                <div>
                    <Box className={styles.optionsRow} style={{marginBottom: '15px'}}>
                        <label style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                            <span style={{fontWeight: 'bold'}}>Tipo de variable:</span>
                            <select
                                style={{
                                    padding: '6px 12px',
                                    borderRadius: '4px',
...
PromptComponent.propTypes = {
    ...
    onVariableTypeChange: PropTypes.func
};
