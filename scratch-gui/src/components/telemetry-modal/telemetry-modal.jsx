...
const messages = defineMessages({
    label: {
        ...
        defaultMessage: 'Report statistics to improve STBlock',
        description: 'STBlock telemetry modal label - for accessibility'
    },
    bodyText1: {
        defaultMessage: 'The STBlock team is always looking to better understand how STBlock is used around the ' +
            'world. To help support this effort, you can allow STBlock to automatically send usage information to ' +
            'the STBlock team.',
        description: 'First paragraph of body text for telemetry opt-in modal',
        id: 'gui.telemetryOptIn.stblock.body1'
    },
    bodyText2: {
    ...
    optInText: {
        defaultMessage: 'Share my usage data with the STBlock Team',
        description: 'Text for telemetry modal opt-in button',
        id: 'gui.telemetryOptIn.stblock.optInText'
    },
    optInTooltip: {
    ...
    optOutText: {
        defaultMessage: 'Do not share my usage data with the STBlock Team',
        description: 'Text for telemetry modal opt-in button',
        id: 'gui.telemetryOptIn.stblock.optOutText'
    },
    optOutTooltip: {
